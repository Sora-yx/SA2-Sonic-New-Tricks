...
2.      Download the latest version of Sonic: New Tricks and place the entire folder in the mods folder.
3.      If all the above steps have been done properly, you should be able to run SA2 Mod Manager and select the mod in the list. (Make sure to also click on Install Loader at the bottom.)
4.      To configure the options for Sonic: New Tricks, select the mod in the Mod Manager and click on 'Configure...' to see all the options. 
